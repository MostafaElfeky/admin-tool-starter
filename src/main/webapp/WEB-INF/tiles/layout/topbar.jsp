...
<header class="topbar">
    <nav class="navbar top-navbar navbar-expand-md navbar-light">
		...
		<div class="navbar-header">
			<a class="navbar-brand" href="${pageContext.request.contextPath}/"> <!-- Logo icon -->
				<b style="height: 50px;"> <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
					<!-- Dark Logo icon -->
					<img src="${pageContext.request.contextPath}/resources/images/favicon.png"
					     alt="homepage" class="dark-logo p-t-10" height="40"> 

...
;(function( $ ) {
	...
	$.fn.eventCalendar.defaults = {
		...
		locales: {
			locale: "en",
			txt_noEvents: "لا توجد أحداث في هذه الفترة",
	...
	function dateSlider(show, flags, eventsOpts) {
		...
		for (dayCount = 1; dayCount <= daysOnTheMonth; dayCount++) {
			...
			/*
			after the last dayCount add + and put the below code
			'<span class="tooltip-content5"><span class="tooltip-text3"><span class="tooltip-inner2"><button id="AddVisit"><i class="fa fa-plus"></i> إضافة زيارة</button><button id="SetupAlert"><i class="fa fa-bell-o"></i> إضافة تنبيه</button></span></span></span>'
			*/
		}

...
;(function( $ ) {
	...
	function dateSlider(show, flags, eventsOpts) {
		...
		for (dayCount = 1; dayCount <= daysOnTheMonth; dayCount++) {
			...
			'<span class="tooltip-content5"><span class="tooltip-text3"><span class="tooltip-inner2"><button id="AddVisit"><i class="fa fa-plus"></i> Add Visit</button><button id="SetupAlert"><i class="fa fa-bell-o"></i> Setup Alert</button></span></span></span>'
			*/
		}
